...
SECRET_KEY = 'django-insecure-)_k_lbesmnn)g_g7oj2i%esuaw+foerm&_)%h-dwssclz=_91$'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'asan_innovators_bank',
        'USER': 'root',
        'PASSWORD': 'Deepak@2005',
        'HOST': 'localhost',  # Set to '127.0.0.1' or the IP address of your MySQL server
